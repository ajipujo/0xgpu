...
@section('content')
    <div class="w-full mb-4 flex justify-between items-center space-x-2">
        <span class="font-semibold text-2xl leading-none text-white">Private Networks (VPC) List</span>
        <a href="{{ route('vpc.create') }}" class="btn btn-primary">Create +</a>
    </div>
                ...
                <div class="card-body">
                    <div class="w-full flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <form action="{{ route('vpc.destroy', ['vpc' => $vpc->id]) }}" method="POST">
                                @csrf
                                @method('delete')
